...
function App() {
    ...
    const showSection = (section) => {
        ...
        setTimeout(() => {
            let elementId = '';
            if (section === 'tech') elementId = 'frontend-title'; else if (section === 'video') elementId = 'video-title'; else if (section === 'about') elementId = 'about-title';
            if (elementId) {
    ...
    return (<div>
        <div>
            ...
            {showHero && (<Hero onTechClick={() => showSection('tech')} onVideoClick={() => showSection('video')}/>)}

            <div ref={sectionRef}>
                {activeSection === 'tech' && (<div className="section">
                    <FrontendProjects/>
                    <BackendProjects/>
                </div>)}
                {activeSection === 'video' && (<div className="section">
                    <VideoPortfolio/>
                </div>)}
                {activeSection === 'about' && (<div className="section">
                    <About/>
                </div>)}
            </div>
